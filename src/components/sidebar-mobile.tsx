...
export function SideBarMobileSection({isOpen, setIsOpen} : WathProps){
 ...
 const handleSeeMore = () =>{
  ...
  return(
    ...
    { 
      isOpen && 
    <div className="w-full bg-black md:hidden lg:hidden block fixed left-0 z-10 top-16 bg-opacity-30" onClick={()=> setIsOpen(false)}>
      <div className="md:w-[15%] lg:w-[15%]  w-[45%] bg-white block h-[100vh] scroll-smooth  scrollbar-thin scrollbar-track-gray-500 overflow-y-scroll"> {/* scroll-smooth  scrollbar-thin scrollbar-track-gray-500 hover:overflow-y-scroll */}
        <ul className="p-2"> 
         {/* First Menu */}
        ...
        <ul className="p-2">
          ...
          <li className='p-2 flex gap-x-4 rounded-lg cursor-pointer hover:bg-slate-100'>
            ...
            <p className="text-left">YouTube Premium</p>
          </li>
          <li className='p-2 flex gap-x-4 rounded-lg cursor-pointer hover:bg-slate-100'>
            ...
            <p className="text-left">YouTube Studio</p>
          </li>
          <li className='p-2 flex gap-x-4 rounded-lg cursor-pointer hover:bg-slate-100'>
          ...
          <p className="text-left"> YouTube Kids </p>
          </li>
        </ul>
        <hr className="my-4"/>
        <ul className="p-2">
          ...
          <p className="text-left"> Settings </p>
          </li>
          <li className='p-2 flex gap-x-4 rounded-lg cursor-pointer hover:bg-slate-100'>
          ...
          <p className="text-left"> Report history </p>
          </li>
          <li className='p-2 flex gap-x-4 rounded-lg cursor-pointer hover:bg-slate-100'>
          ...
          <p className="text-left"> Send feedback </p>
            
          </li>
          <li className=' flex rounded-lg cursor-pointer text-[12px] pb-16'>
